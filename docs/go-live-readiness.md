...
| Area | Status | Notes |
| --- | --- | --- |
| Rules hardening | Completed | Subscriptions and support creation are backend-write-only; teacher access is assignment-bound; analytics and learning event payloads are constrained. |
